...
{% hint style="info" %}
**안내**\
다이내믹 패널의 캐스퍼 1:1 채팅방에 대한 설명은 사용자 가이드 > [다이내믹 패널](dynamic-panel.md) 문서를 참고하시기 바랍니다.
{% endhint %}
...
카카오 i 캐스퍼 지식 검색 서비스를 이용하기 위해서는 관리자가 질문과 답변 데이터를 직접 등록해야 합니다. 자세한 설명은 [관리자 가이드 > 봇 관리](../guide/admin/bot.md) 문서를 참고하시기 바랍니다.
