...
| 사용자     | <p>관리자나 Bot 개발자 권한 없이, 카카오워크만 사용하는 멤버<br>- 자세한 사용 방법은 Kakao Work 관리자(PC) 문서를 참고</p>                        | 관리자 서비스에 접근 불가                                                                                                  |
...
| 구분         | 접속 방법                                                                                                                                                                                      |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 바로가기 링크    | <p><a href="https://admin.kakaowork.com/">관리자 서비스 링크</a>로 접속<br>- [카카오워크 사이트](https://www.kakaowork.com)에서 [관리자] 버튼을 클릭하여 접속도 가능</p> |
| 카카오워크 PC 앱 | 더보기 탭 관리자 페이지로 이동 카카오워크 관리자 서비스 바로가기 클릭                                                                                                                                                    |

{% hint style="info" %}
**안내**\
카카오워크 관리자 서비스의 메뉴 구성에 대한 설명은 [부록 A. 카카오워크 관리자](https://docs.kakaoi.ai/kakao_work/botdevguide/admin_site/) 문서를 참고하시기 바랍니다.
{% endhint %}

## 워크스페이스 개설

**워크스페이스**란 회사 및 조직 단위로 구성되는 개별적인 업무 공간으로, 멤버들이 자유롭게 소통할 수 있는 공간을 의미합니다. 워크스페이스를 직접 개설한 경우 '슈퍼 관리자'가 됩니다.
...
설정한 조직 ID를 변경할 수 있습니다. 조직 ID는 생성한 후 삭제할 수 없으며, 변경만 가능합니다.
