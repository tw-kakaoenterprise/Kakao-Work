...
| ⓷ 채팅방 리스트 ▼ | 참여 중인 모든 채팅방 표시 <br> Bot과의 채팅방, 나와의 채팅방, 그룹 채팅방, 비밀 채팅방 등  |

{% endtab %}

{% tab title="Mobile" %}
<figure><img src="../../.gitbook/assets/Untitled (1).png" alt=""><figcaption>카카오워크 Mobile</figcaption></figure>
